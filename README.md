...
## Dataset
The dataset for this analysis can be downloaded [here](https://github.com/bohuali23/AB_TEST/blob/main/application.csv).
...
Please refer to the attached [slides](https://github.com/bohuali23/AB_TEST/blob/main/instacart%20slides.pptx) for a summary of the findings and recommendations. The appendix contains additional content, including code snippets and workbooks used for the analysis.
